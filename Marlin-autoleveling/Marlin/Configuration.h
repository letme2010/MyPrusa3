...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -12.5
  ...
  #define SLED_DOCKING_OFFSET 20 // the extra distance the X axis must travel to pickup the sled. 0 should be fine but you can push it further if you'd like.

  #define SERVO0_PIN A1
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 400, 106}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {500, 300, 3.2, 25}    // (mm/sec)
