...
//                       Y_PROBE_OFFSET_FROM_EXTRUDER, z_loc);
	 ...
	 if (current_position[Z_AXIS] < SLED_DOCKING_OFFSET) {
		 do_blocking_move_to(current_position[X_AXIS],current_position[Y_AXIS],SLED_DOCKING_OFFSET);
	 }
  ...
  if(code_seen('G'))
  {
    ...
    case 28: //G28 Home all Axis one at a time
      ...
      feedrate = 0.0;
          ...
          HOMEAXIS(X);
          HOMEAXIS(Y);
          dock_sled(false);HOMEAXIS(Z);dock_sled(true);
