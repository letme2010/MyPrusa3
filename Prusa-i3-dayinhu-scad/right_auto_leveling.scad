...
height = LM8UU_h;
difference() {
    translate(v=[-15,12,height/2]) 
        cube(size = [17,42,height], center = true);
    translate(v=[-15,12,height/2 + 1])
        cube(size = [17-6,9,height+2], center = true);
    translate(v=[-15,26,height/2 + 1])
        cube(size = [17-6,9,height+2], center = true);
    translate(v=[-15,-2,height/2 + 1]) 
        cube(size = [17-6,9,height+2], center = true);
}
// Bearing holder
